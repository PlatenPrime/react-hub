...
const HookUseRef = () => {
	...
	return (
		<div className='space-y-5 bg-slate-400'>
			...
			<button className='bg-sky-600 p-2 hover:bg-sky-500' onClick={() => { setRef(input.current.value); setRender(prev => prev + 1) }} >
				Присвоить значение рефа
			</button>

			<div className='flex justify-center items-center my-10' >

				<h2 className='text-xl'>
					Количество рендеров: {render}
				</h2>
